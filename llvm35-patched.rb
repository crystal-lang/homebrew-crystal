class Llvm35Patched < Formula
  ...
  # https://llvm.org/bugs/show_bug.cgi?id=20800
  patch :p0 do
    url "https://raw.githubusercontent.com/manastech/omnibus-crystal/master/config/patches/llvm/PR20800.patch"
    sha1 "cc9362dbdf6417c42caeb08035b9a98b6ff2124d"
  end
